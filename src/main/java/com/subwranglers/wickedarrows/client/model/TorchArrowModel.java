...
public class TorchArrowModel<T extends  TorchArrowEntity> extends EntityModel<T> {
    private final RendererModel arrow;
    private final RendererModel torch1;
    private final RendererModel torch2;

    public TorchArrowModel() {
        textureWidth = 32;
        textureHeight = 32;
